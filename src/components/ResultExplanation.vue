<template>
  <div v-if="isNaN(this.data_you_profession)">
    We are sorry that your gender bias of the profession "{{this.profession}}" could not be calculated.
  </div>
  <div v-else-if="this.data_you_profession > this.data_AI_profession">
